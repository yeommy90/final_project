...
public class ListDTO {
	...
	public ListDTO(int movie_id, String title, String original_title, Date release_date, int popularity,
			Double tmdb_vote_sum, int tmdb_vote_cnt, Double vote_sum, int vote_cnt, String overView, String poster_path,
	...
	public Double getVote_sum() {
		return vote_sum;
	}

	public void setVote_sum(Double vote_sum) {
		this.vote_sum = vote_sum;
	}
